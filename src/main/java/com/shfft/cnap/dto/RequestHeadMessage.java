 ...
 * www.bplow.com
 */
package com.shfft.cnap.dto;

import com.shfft.cnap.anontation.block;
...
public class RequestHeadMessage {
	...
	private String mesgPriority;//报文优先级
	
	@block(index=13,lenght=1,value="")
	private String mesgDirection;//报文传输方向
